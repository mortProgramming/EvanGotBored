...
import com.MORTlib.Swerve.DriveController;
import com.MORTlib.Swerve.DriveControllerFactory;
import com.MORTlib.Swerve.MechanicalConfiguration;
...
public final class Krakenx60DriveControllerFactoryBuilder {
    ...
    private class FactoryImplementation implements DriveControllerFactory<ControllerImplementation, Integer> {
        ...
        public ControllerImplementation create(Integer id, String canbus, MechanicalConfiguration mechConfiguration) {
            ...
            CtreUtils.checkCtreError(motor.getConfigurator().apply(motorConfiguration), "Failed to configure Kraken x60");
    ...
    private class ControllerImplementation implements DriveController {
        ...
        // private final double nominalVoltage = hasVoltageCompensation() ? Krakenx60DriveControllerFactoryBuilder.this.nominalVoltage : 12.0;

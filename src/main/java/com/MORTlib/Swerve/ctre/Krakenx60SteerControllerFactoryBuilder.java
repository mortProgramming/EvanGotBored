package com.MORTlib.Swerve.ctre;
...
import com.MORTlib.Swerve.*;

import edu.wpi.first.wpilibj.motorcontrol.MotorController;
import edu.wpi.first.wpilibj.shuffleboard.ShuffleboardContainer;

import static com.MORTlib.Swerve.ctre.CtreUtils.checkCtreError;
...
public final class Krakenx60SteerControllerFactoryBuilder {
    ...
    public Krakenx60SteerControllerFactoryBuilder withPidConstants(double proportional, double integral,
            double derivative) {
    ...
    public Krakenx60SteerControllerFactoryBuilder withMotionMagic(double velocityConstant, double accelerationConstant,
    ...
    private class FactoryImplementation<T>
        ...
        public ControllerImplementation create(SteerConfiguration<T> steerConfiguration, String canbus,
            ...
            checkCtreError(motor.getConfigurator().apply(motorConfiguration, CAN_TIMEOUT_SEC),
                    "Failed to configure Kraken x60 settings");
            ...
            //         "Failed to set Kraken x60 feedback sensor");
            ...
            checkCtreError(
                    motor.setPosition(absoluteEncoder.getAbsoluteAngle() / sensorPositionCoefficient,
                            CAN_TIMEOUT_SEC),
                    "Failed to set Kraken x60 encoder position");
            ...
            CtreUtils.checkCtreError(
                    ...
                    "Failed to configure Kraken status frame period"
            );
            CtreUtils.checkCtreError(
